...
type BytesMessage struct {
	...
	// Earthly specific - the index of the output.
	Index int64 `protobuf:"varint,101,opt,name=index,proto3" json:"index,omitempty"`
}
...
func (m *BytesMessage) GetIndex() int64 {
	if m != nil {
		return m.Index
	}
	return 0
...
var fileDescriptor_d1042549f1f24495 = []byte{
	...
	,
	...
	0x1e, 0xcb, 0x31, 0x44, 0x71, 0xc0, 0xcc, 0x4c, 0x62, 0x03, 0x47, 0x8e, 0x31, 0x20, 0x00, 0x00,
	0xff, 0xff, 0x8a, 0x34, 0x77, 0xf2, 0xae, 0x01, 0x00, 0x00,
}
...
func (m *BytesMessage) Size() (n int) {
	...
	if m.Index != 0 {
		n += 2 + sovFilesync(uint64(m.Index))
	}
	return n
}
